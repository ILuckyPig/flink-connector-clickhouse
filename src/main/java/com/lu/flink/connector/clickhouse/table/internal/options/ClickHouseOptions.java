package com.lu.flink.connector.clickhouse.table.internal.options;
...
public class ClickHouseOptions {
    ...
    private ClickHouseOptions(String url, @Nullable String username, @Nullable String password,
                              String databaseName, String tableName, int batchSize, Duration flushInterval,
                              int maxRetires, boolean writeLocal, String partitionStrategy, String partitionKey,
    ...
    public static class Builder {
        ...
        public ClickHouseOptions build() {
            return new ClickHouseOptions(url, username, password, databaseName, tableName,
                    batchSize, flushInterval, maxRetries, writeLocal, partitionStrategy,
                    partitionKey, ignoreDelete);
        }
    }
}
